      ...
      <tr>
        <td width="205" height="185"><table width="1035" border="0">
          ...
          <tr>
            ...
            <td>&nbsp;</td>
            <td rowspan="10"><iframe width="600" height="315" src="http://www.youtube.com/embed/nsfWfZlIL70" frameborder="0" allowfullscreen></iframe></td>
            <td>&nbsp;</td>
          </tr>
          <tr>
 ...
 ?>
              ...
              <tr>
                <td><label></label><label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label>
                  <form id="form1" name="form1" method="post" action="yorumdongu.php">
                    <label>
                    <textarea name="dd" cols="70" rows="10" id="dd"></textarea>
                    </label>
                    <br />
                    <label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
