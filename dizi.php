      ...
      <tr>
        <td width="205" height="185"><table width="1035" border="0">
          ...
          <tr>
            ...
            <td>&nbsp;</td>
            <td rowspan="10"><iframe width="600" height="315" src="http://www.youtube.com/embed/XigU6UeZ0pE" frameborder="0" allowfullscreen></iframe></td>
            <td>&nbsp;</td>
          </tr>
          <tr>
...
while($satir = mysql_fetch_array($sonuc))
 ...
 ?>
              ...
              <tr>
                <td><form id="form1" name="form1" method="post" action="yorumdizi.php">
                  <label>
                  <textarea name="ee" cols="70" rows="10" id="ee"></textarea>
                  </label>
                  <br />
                  <label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                  <input name="Submit2" type="reset" value="        Temizle        " />
                  &nbsp;&nbsp;&nbsp;&nbsp;
                   <input name="gnd" type="submit" id="gnd"action="yorum.php" value="        G&ouml;nder        " />
                   &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label>
                  <br />
                </form>                </td>
              </tr>
