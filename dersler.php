      ...
      <tr>
        <td width="205" height="185"><table width="1035" border="0">
          ...
          <tr>
            ...
            <td>&nbsp;</td>
            <td rowspan="10"><iframe width="600" height="315" src="http://www.youtube.com/embed/hYEZ9DDPdTk" frameborder="0" allowfullscreen></iframe></td>
            <td>&nbsp;</td>
          </tr>
          <tr>
 ...
 ?>
              ...
              <tr>
                <td><label></label><label>&nbsp;</label>
                  <form id="form1" name="form1" method="post" action="yorum.php">
                    <label>
                    <textarea name="aa" cols="70" rows="10"></textarea>
                    </label>
                    <br />
                    <label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
