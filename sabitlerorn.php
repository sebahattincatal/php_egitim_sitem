    ...
    <td width="218" height="585"><table width="211" border="0">
      <tr>
        <td width="205" height="185"><table width="200" border="0" align="center">
          ...
          <tr>
            <td><div align="center"><a href="operatorlerorn.php"><img src="g.jpg" width="145" height="29" /></a></div></td>
          </tr>
          <tr>
      ...
      <tr>
        <td height="36"><form id="form1" name="form1" method="post" action="arama.php">
          <table width="200" border="0" align="right">
            <tr>
              <td width="120"><label>
                <input name="ara" type="text" id="ara" size="20" />
                </label>
              </td>
              <td width="64"><p>
      ...
      <tr>
        <td height="271"><blockquote>
          <p><a href="Anasayfa.php"></a></p>
        </blockquote></td>
        </tr>
    </table></td>
    <td width="831" colspan="3"><table width="540" height="533" border="0" align="center">
      <tr>
        <td height="529" colspan="2"><p><img src="sabitler.jpg" width="585" height="414" /></p></td>
        </tr>
        <tr>
        <td><p>  <?php
