      ...
      <tr>
        <td width="205" height="185"><table width="1035" border="0">
          ...
          <tr>
            ...
            <td>&nbsp;</td>
            <td rowspan="10"><iframe width="600" height="315" src="http://www.youtube.com/embed/7_IU3CzkDXk" frameborder="0" allowfullscreen></iframe></td>
            <td>&nbsp;</td>
          </tr>
          <tr>
...
while($satir = mysql_fetch_array($sonuc))
 ...
 ?>
              ...
              <tr>
                <td><form id="form1" name="form1" method="post" action="yorumopera.php">
                  <label>
                  <textarea name="rr" cols="70" rows="10" id="rr"></textarea>
                  </label>
                  <br />
                  <label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
