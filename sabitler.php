    ...
    <td width="219"><table width="211" border="0">
      <tr>
        <td width="205" height="185"><table width="1035" border="0">
          ...
          <tr>
            <td width="194"><div align="center"><a href="dersler.php"><img src="A.jpg" width="145" height="29" /></a></div></td>
            <td>&nbsp;</td>
            <td rowspan="10"><iframe width="600" height="315" src="http://www.youtube.com/embed/yE_4jKb34jY" frameborder="0" allowfullscreen></iframe></td>
            <td>&nbsp;</td>
          </tr>
          <tr>
...
while($satir = mysql_fetch_array($sonuc))
	{
		...
		$konu=$satir["konu"];
		if($konu=="sabitler"){
		echo "<tr bgcolor='$renk'><td align='center'>$resim1</td></tr>";
 ...
 ?>
              ...
              <tr>
                <td><form id="form1" name="form1" method="post" action="yorumsabit.php">
                  <label>
                  <textarea name="bb" cols="70" rows="10" id="bb"></textarea>
                  </label>
                  <br />
                  <label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
