 ...
 <?php
			  $bag = mysql_connect("localhost","root",""); 
                    ...
                    mysql_query("SET COLLATION_CONNECTION = 'latin5_turkish_ci' ");
						...
						$yorum1=mysql_real_escape_string($_REQUEST["rr"]);
						$y=htmlentities($yorum1);
						$a="operator";
						$sql = "INSERT INTO yorum (yorum2, yukleyen,konu) VALUES ('$y', '$kadi','$a')";
						...
						header("location:operatorler.php");
						?>
 </body>
 </html>