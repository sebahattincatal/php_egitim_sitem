...
<table width="1059" height="779" border="0" align="center" bgcolor="#FFFFFF">
  ...
  <tr>
    ...
    <td width="831" colspan="3"><table width="540" height="571" border="0" align="center">
      <tr>
        <td height="567" colspan="2"><p><img src="fonksiyon.jpg" width="606" height="404" /></p></td>
        </tr>
          <?php
$bag = mysql_connect("localhost","root",""); 
if (!$bag) { die('Ba?lanty hatasy: ' . mysql_error()); }
